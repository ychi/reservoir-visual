...
data = read_json('/home/ice479/reservoir-visual-data/data/data.json')
...
write_json('/home/ice479/reservoir-visual-data/data/data' + date + str(now.hour) + '.json', data)
write_json('/home/ice479/reservoir-visual-data/data/data.json', data)
